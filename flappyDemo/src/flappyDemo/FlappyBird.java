...
public class FlappyBird implements ActionListener ,MouseListener
{
	...
	public void addColumn(boolean start) 
	{
		 int space = 300;
	        ...
	        {
	            columns.add(new Rectangle(((Rectangle)columns.get(columns.size() - 1)).x + 600, 800 - height - 120, width, height));
	            columns.add(new Rectangle(((Rectangle)columns.get(columns.size() - 1)).x, 0, width, 800 - height - space));
	        }
	}
